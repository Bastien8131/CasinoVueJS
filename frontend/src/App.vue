<script setup>
	...
	const showBurger = () => {
		toggler.value.classList.toggle('active');
		menu.value.classList.toggle('active');
	}

	const closeMenu = () => {
		toggler.value.classList.remove('active');
...
<template>
	...
	<div ref="menu" class="menu">
		...
		<a @click="changeContent('Baccarat')" class="btn-sidebar" id="Baccarat">Baccarat</a>
	</div>
	<component class="main-content" :is="content">
		...
		<Baccarat v-if="content === 'Baccarat'"></Baccarat>
	</component>
	<div class="hud-value" v-if="content !== 'connexion' && content !== 'inscription'">
		<div class="content">
			<div ref="toggler" @click="showBurger" class="menu__toggler"><span></span></div>
